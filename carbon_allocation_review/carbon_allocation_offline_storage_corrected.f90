  ...
  !--------------------------------------------------------------------------
   ...
   !==========================================================================
      subroutine allocate_gradual_with_storage(state, params, controls, npp_rate, &
         ...
         storage_after_npp = carbon_storage + result%npp_daily

         ! Storage cannot become negative. If NPP is strongly negative, the
         ! remaining deficit must be handled elsewhere by respiration, tissue
         ! turnover, mortality, or another carbon-balance closure term.
         ...
         ! Diagnostics.
         result%carbon_balance_error = result%carbon_to_allocate - &
            (result%delta_leaf + result%delta_root + result%delta_sapwood)
